...
invoke_model_id = "anthropic.claude-3-5-haiku-20241022-v1:0"
dashboard_name = "Contextual-AgentOps-Dashboard"
...
def generate_dashboard_json(region, knowledge_base_name, invoke_model_id):
    ...
    dashboard_def = {
        ...
        "widgets": [
            ...
            # Add these new widgets to the "widgets" list in the dashboard_def dictionary
            {
                "height": 6,
                "width": 12,
                "y": 18,  # Adjust y coordinate as needed
                "x": 0,
                "type": "log",
                "properties": {
                    "query": "SOURCE '/agentops/bedrock/llm' | fields @timestamp, modelId, operation\n| stats count(*) as invocations by modelId\n| sort invocations desc",
                    "region": region,
                    "stacked": False,
            ...
            },
            {
                ...
                "type": "log",
                "properties": {
                    "query": "SOURCE '/agentops/bedrock/llm' | fields @timestamp, requestId, operation, modelId\n| stats count(*) as requestCount by bin(1h)",
                    "region": region,
                    "stacked": False,
                    "title": "Request Patterns (Hourly)",
                    "view": "timeSeries",
                },
            },
            {
                "height": 6,
                "width": 24,
                "y": 24,  # Adjust y coordinate as needed
                "x": 0,
                "type": "log",
                "properties": {
                    "query": "SOURCE '/agentops/bedrock/llm' | fields @timestamp, identity.arn, modelId\n| stats count(*) as invocations by identity.arn, modelId\n| sort invocations desc",
                    "region": region,
                    "stacked": False,
                    "title": "Usage by Identity and Model",
                    "view": "table",
                },
            },
